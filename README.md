...
| 0059 | [Spiral Matrix II](https://leetcode.com/problems/spiral-matrix-ii) | Medium | `Array` `Matrix` `Simulation` |
| 0060 | [Permutation Sequence](https://leetcode.com/problems/permutation-sequence) | Hard | `Math` `Recursion` |
...
| 0204 | [Count Primes](https://leetcode.com/problems/count-primes) | Medium | `Array` `Enumeration` `Math` `Number Theory` |
...
| 0477 | [Total Hamming Distance](https://leetcode.com/problems/total-hamming-distance) | Medium | `Array` `Bit Manipulation` `Math` |
...
| 0826 | [Most Profit Assigning Work](https://leetcode.com/problems/most-profit-assigning-work) | Medium | `Array` `Binary Search` `Greedy` `Sorting` `Two Pointers` |
...
| 1509 | [Minimum Difference Between Largest and Smallest Value in Three Moves](https://leetcode.com/problems/minimum-difference-between-largest-and-smallest-value-in-three-moves) | Medium | `Array` `Greedy` `Sorting` |
...
| 2391 | [Minimum Amount of Time to Collect Garbage](https://leetcode.com/problems/minimum-amount-of-time-to-collect-garbage) | Medium | `Array` `Prefix Sum` `String` |
...
| 2433 | [Find The Original Array of Prefix Xor](https://leetcode.com/problems/find-the-original-array-of-prefix-xor) | Medium | `Array` `Bit Manipulation` |
...
| 2521 | [Distinct Prime Factors of Product of Array](https://leetcode.com/problems/distinct-prime-factors-of-product-of-array) | Medium | `Array` `Hash Table` `Math` `Number Theory` |
...
| 2740 | [Find the Value of the Partition](https://leetcode.com/problems/find-the-value-of-the-partition) | Medium | `Array` `Sorting` |
